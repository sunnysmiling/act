(function() {
	...
	var SimpleToast = /*@__PURE__*/ (function(Component) {
		function SimpleToast(props) {}

		if (Component) SimpleToast.__proto__ = Component;
		SimpleToast.prototype = Object.create(Component && Component.prototype);
		SimpleToast.prototype.constructor = SimpleToast;
		SimpleToast.prototype.demo = function(type) {
			if (type === "文字提示") {
				Toast("提示内容");
			} else if (type === "加载提示") {
				Toast.loading({
		...
		SimpleToast.prototype.render = function() {
			var this$1 = this;
			return apivm.h(
				"view",
				{class: "page"},
				apivm.h(ANavBar, {title: "simple-toast", "left-arrow": true}),
				apivm.h(
					"scroll-view",
					...
					apivm.h(
						"view",
						{class: "simple"},
						apivm.h("text", {class: "simple-title"}, "自定义位置"),
	...
	apivm.define("simple-toast", SimpleToast);
})();
