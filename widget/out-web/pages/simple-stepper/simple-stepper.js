(function() {
	...
	var SimpleStepper = /*@__PURE__*/ (function(Component) {
		...
		if (Component) SimpleStepper.__proto__ = Component;
		SimpleStepper.prototype = Object.create(Component && Component.prototype);
		SimpleStepper.prototype.constructor = SimpleStepper;
		SimpleStepper.prototype.onChange1 = function(e) {
			Toast("onChange:\n" + JSON.stringify(e));
		};
		SimpleStepper.prototype.setStep = function() {
			this.data.step = 7;
		};
		SimpleStepper.prototype.beforeChange = function(value) {
		...
		SimpleStepper.prototype.render = function() {
			var this$1 = this;
			return apivm.h(
				"view",
				{class: "page"},
				apivm.h(ANavBar, {title: "simple-stepper", "left-arrow": true}),
				apivm.h(
					"scroll-view",
						...
						apivm.h(
							...
							apivm.h("a-stepper", {
								...
								onChange: function(event) {
									if (this$1.onChange1) {
										this$1.onChange1(event);
									} else {
										onChange1(event);
									}
								}
							}),
							apivm.h("text", {class: "simple-title"}, this.data.value[0])
						)
					),
					...
					apivm.h(
						...
						apivm.h(
							"text",
							{class: "simple-title", onClick: this.setStep},
							"设置步长"
						),
						apivm.h(
							"text",
						...
						apivm.h(
							"view",
							{class: "simple-box"},
							apivm.h("a-stepper", {$value: "value[1]", step: this.data.step})
						)
					),
					...
					apivm.h(
						"view",
						{class: "simple"},
						apivm.h("text", {class: "simple-title"}, "输入范围"),
						apivm.h(
							"text",
							{class: "simple-desc"},
						...
						apivm.h(
							"view",
							{class: "simple-box"},
							apivm.h("a-stepper", {$value: "value[2]", min: "5", max: "8"})
						)
					),
					...
					apivm.h(
						"view",
						{class: "simple"},
						apivm.h("text", {class: "simple-title"}, "限制输入整数"),
						apivm.h(
							"text",
							{class: "simple-desc"},
						...
						apivm.h(
							"view",
							{class: "simple-box"},
							apivm.h("a-stepper", {$value: "value[3]", integer: true})
						)
					),
					...
					apivm.h(
						"view",
						{class: "simple"},
						apivm.h("text", {class: "simple-title"}, "禁用状态"),
						apivm.h(
							"text",
							{class: "simple-desc"},
						...
						apivm.h(
							"view",
							{class: "simple-box"},
							apivm.h("a-stepper", {$value: "value[4]", disabled: true})
						)
					),
					...
					apivm.h(
						...
						apivm.h(
							"view",
							{class: "simple-box"},
							apivm.h("a-stepper", {$value: "value[5]", "disable-input": true})
						)
					),
					...
					apivm.h(
						"view",
						{class: "simple"},
						apivm.h("text", {class: "simple-title"}, "固定小数位数"),
						apivm.h(
							"text",
							{class: "simple-desc"},
					...
					apivm.h(
						"view",
						{class: "simple"},
						apivm.h("text", {class: "simple-title"}, "自定义大小"),
						apivm.h(
							"text",
							{class: "simple-desc"},
					...
					apivm.h(
						"view",
						{class: "simple"},
						apivm.h("text", {class: "simple-title"}, "圆角风格"),
						apivm.h(
							"text",
							{class: "simple-desc"},
					...
					apivm.h(
						"view",
						{class: "simple"},
						apivm.h("text", {class: "simple-title"}, "异步变更"),
						apivm.h(
							"text",
							{class: "simple-desc"},
						...
						apivm.h(
							...
							apivm.h("a-stepper", {
								$value: "value[8]",
								"before-change": this.beforeChange
							})
						)
					),
	...
	apivm.define("simple-stepper", SimpleStepper);
})();
