(function() {
	...
	var SimpleSearch = /*@__PURE__*/ (function(Component) {
		...
		if (Component) SimpleSearch.__proto__ = Component;
		SimpleSearch.prototype = Object.create(Component && Component.prototype);
		SimpleSearch.prototype.constructor = SimpleSearch;
		SimpleSearch.prototype.onSearch = function(e) {
			api.toast({
				msg: e.detail.value
			});
		};
		SimpleSearch.prototype.onCancel = function(e) {
			api.toast({
				msg: "取消"
			});
		};
		SimpleSearch.prototype.render = function() {
			return apivm.h(
				"view",
				{class: "page"},
				apivm.h("a-nav-bar", {title: "simple-search", "left-arrow": true}),
				apivm.h(
					"scroll-view",
					...
					apivm.h(
						"view",
						{class: "simple"},
						apivm.h("text", {class: "simple-title"}, "事件监听"),
					...
					apivm.h(
						"view",
						{class: "simple"},
						apivm.h("text", {class: "simple-title"}, "搜索框内容对齐"),
					...
					apivm.h(
						"view",
						{class: "simple"},
						apivm.h("text", {class: "simple-title"}, "禁用搜索框"),
					...
					apivm.h(
						"view",
						{class: "simple"},
						apivm.h("text", {class: "simple-title"}, "自定义背景"),
					...
					apivm.h(
						...
						apivm.h(
							...
							apivm.h(
								"template",
								{_slot: "action"},
								apivm.h("text", {onClick: this.onSearch}, "搜索")
							)
						)
					)
				)
	...
	apivm.define("simple-search", SimpleSearch);
})();
