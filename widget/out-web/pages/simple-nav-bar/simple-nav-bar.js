(function() {
	...
	var SimpleNavBar = /*@__PURE__*/ (function(Component) {
		function SimpleNavBar(props) {}

		if (Component) SimpleNavBar.__proto__ = Component;
		SimpleNavBar.prototype = Object.create(Component && Component.prototype);
		SimpleNavBar.prototype.constructor = SimpleNavBar;
		SimpleNavBar.prototype.onClickLeft = function() {
			Toast("返回2");
		};
		SimpleNavBar.prototype.onClickRight = function() {
			Toast("右侧");
		};
		SimpleNavBar.prototype.render = function() {
			return apivm.h(
				"view",
				{class: "page"},
				apivm.h(ANavBar, {title: "simple-nav-bar", "left-arrow": true}),
				apivm.h(
					"scroll-view",
					{style: "flex: 1;"},
					...
					apivm.h(
						"view",
						{class: "simple"},
						apivm.h("text", {class: "simple-title"}, "不要底边线"),
						apivm.h(
							"text",
							{class: "simple-desc"},
							"通过添加 hide-line 属性设置隐藏底边线。"
						),
						apivm.h("a-nav-bar", {"hide-line": true, title: "没有底边线"})
					),
					...
					apivm.h(
						...
						apivm.h(
							"a-nav-bar",
							{title: "标题", "left-text": "返回", "left-arrow": true},
							apivm.h(
								"template",
								{_slot: "right", class: "demo-right"},
								apivm.h("a-icon", {name: "search", color: "blue", size: "18"}),
								apivm.h("text", {style: "color:green"}, "文本")
							)
						)
					),
					...
					apivm.h(
						"view",
						{class: "simple"},
						apivm.h("text", {class: "simple-title"}, "单图标居中测试"),
						apivm.h("a-nav-bar", {
							title: "只有左边",
							"left-text": "返回",
							"left-arrow": true
						...
						apivm.h(
							...
							apivm.h(
								"template",
								{_slot: "right", class: "demo-right"},
								apivm.h("a-icon", {name: "search", size: "18"}),
								apivm.h("text", null, "文本")
							)
						)
					)
				)
	...
	SimpleNavBar.css = {
		...
		".demo-right": {flexFlow: "row nowrap", alignItems: "center"}
	};
	apivm.define("simple-nav-bar", SimpleNavBar);
})();
