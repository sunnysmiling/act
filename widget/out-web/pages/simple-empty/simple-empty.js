(function() {
	...
	var SimpleEmpty = /*@__PURE__*/ (function(Component) {
		function SimpleEmpty(props) {}

		if (Component) SimpleEmpty.__proto__ = Component;
		SimpleEmpty.prototype = Object.create(Component && Component.prototype);
		SimpleEmpty.prototype.constructor = SimpleEmpty;
		SimpleEmpty.prototype.render = function() {
			return apivm.h(
				"view",
				{class: "page"},
				apivm.h(ANavBar, {title: "simple-empty", "left-arrow": true}),
				apivm.h(
					"scroll-view",
					...
					apivm.h(
						...
						apivm.h("a-empty", {description: "描述文字"})
					),

					apivm.h(
						"view",
						{class: "simple"},
						apivm.h("text", {class: "simple-title"}, "通用错误"),

						apivm.h("a-empty", {image: "error", description: "描述文字"})
					),

					apivm.h(
						"view",
						{class: "simple"},
						apivm.h("text", {class: "simple-title"}, "网络错误"),

						apivm.h("a-empty", {image: "network", description: "描述文字"})
					),

					apivm.h(
						"view",
						{class: "simple"},
						apivm.h("text", {class: "simple-title"}, "搜索提示"),
						apivm.h("a-empty", {image: "search", description: "描述文字"})
					),

					apivm.h(
						"view",
						{class: "simple"},
						apivm.h("text", {class: "simple-title"}, "自定义图片"),
						apivm.h("a-empty", {
							class: "custom-image",
							image:
								"https://icon.yangyongan.com/?name=warning&size=64&scale=2&color=_ddd",
							"image-size": "88",
							description: "描述文字"
						})
					),
					...
					apivm.h(
						"view",
						{class: "simple"},
						apivm.h("text", {class: "simple-title"}, "底部插槽"),
						apivm.h(
							"a-empty",
							{description: "描述文字"},
							apivm.h(
								"a-button",
								{round: true, type: "danger", class: "bottom-button"},
								"按钮测试"
							)
						)
					)
	...
	apivm.define("simple-empty", SimpleEmpty);
})();
