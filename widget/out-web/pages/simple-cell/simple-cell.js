(function() {
	...
	var SimpleCell = /*@__PURE__*/ (function(Component) {
		function SimpleCell(props) {}

		if (Component) SimpleCell.__proto__ = Component;
		SimpleCell.prototype = Object.create(Component && Component.prototype);
		SimpleCell.prototype.constructor = SimpleCell;
		SimpleCell.prototype.showParam = function(msg) {
			console.log(msg);
		};
		SimpleCell.prototype.render = function() {
			...
			return apivm.h(
				"view",
				{class: "page"},
				apivm.h(ANavBar, {title: "simple-cell", "left-arrow": true}),
				apivm.h(
					"scroll-view",
					...
					apivm.h(
						...
						apivm.h(
							...
							apivm.h("a-cell", {
								...
								value: "内容",
								onClick: function() {
									return this$1.showParam("Vue风格传参");
								}
							}),
							apivm.h("a-cell", {
								title: "单元格",
								...
								label: "描述信息",
								onClick: function() {
									return this$1.showParam("React风格传参");
								}
							})
						)
					),
					...
					apivm.h(
						"view",
						{class: "simple"},
						apivm.h("text", {class: "simple-title"}, "单元格大小"),
						apivm.h(
							"text",
							{class: "simple-desc"},
						...
						apivm.h(
							"a-cell-group",
							null,
							apivm.h("a-cell", {title: "单元格", value: "内容", size: "large"}),
							apivm.h("a-cell", {
								title: "单元格",
								value: "内容",
								size: "large",
					...
					apivm.h(
						"view",
						{class: "simple"},
						apivm.h("text", {class: "simple-title"}, "展示图标"),
						apivm.h(
							"text",
							{class: "simple-desc"},
							"通过 icon 属性在标题左侧展示图标。"
						...
						apivm.h(
							"a-cell-group",
							null,
							apivm.h("a-cell", {title: "单元格", icon: "map"})
						)
					),
					...
					apivm.h(
						"view",
						{class: "simple"},
						apivm.h("text", {class: "simple-title"}, "快捷标题"),
						apivm.h(
							"text",
							{class: "simple-desc"},
							"子节点是纯文本的时候被理解成title"
						),
						apivm.h("a-cell", null, "单元格")
					),

					apivm.h(
						"view",
						{class: "simple"},
						apivm.h("text", {class: "simple-title"}, "展示箭头"),
						apivm.h(
							"text",
							{class: "simple-desc"},
						...
						apivm.h(
							"a-cell-group",
							null,
							apivm.h("a-cell", {title: "单元格", "is-link": true}),
							apivm.h("a-cell", {title: "单元格", "is-link": true, value: "内容"}),
							apivm.h("a-cell", {
								title: "单元格",
								"is-link": true,
					...
					apivm.h(
						"view",
						{class: "simple"},
						apivm.h("text", {class: "simple-title"}, "分组标题"),
						apivm.h(
							"text",
							{class: "simple-desc"},
						...
						apivm.h(
							"a-cell-group",
							{title: "分组1"},
							apivm.h("a-cell", {title: "单元格", value: "内容"})
						),
						apivm.h(
							"a-cell-group",
							{title: "分组2"},
					...
					apivm.h(
						"view",
						{class: "simple"},
						apivm.h("text", {class: "simple-title"}, "分组圆角"),
						apivm.h(
							"text",
							{class: "simple-desc"},
					...
					apivm.h(
						"view",
						{class: "simple"},
						apivm.h("text", {class: "simple-title"}, "使用插槽"),
						apivm.h(
							"text",
							{class: "simple-desc"},
						...
						apivm.h(
							...
							apivm.h(
								"a-cell",
								{value: "内容", "is-link": true},

								apivm.h(
									"template",
									{_slot: "title"},
									apivm.h("text", {class: "custom-title"}, "自定义标题"),
							...
							apivm.h(
								"a-cell",
								{title: "相机扫码", icon: "camera"},

								apivm.h(
									"template",
									{_slot: "right-icon"},
									apivm.h("a-icon", {name: "scanning", class: "search-icon"})
								)
							)
						)
					),
					...
					apivm.h(
						"view",
						{class: "simple"},
						apivm.h("text", {class: "simple-title"}, "垂直居中"),
						apivm.h(
							"text",
							{class: "simple-desc"},
	...
	SimpleCell.css = {
		...
		".custom-title": {fontSize: "14px", color: "#fa8919"}
	};
	apivm.define("simple-cell", SimpleCell);
})();
